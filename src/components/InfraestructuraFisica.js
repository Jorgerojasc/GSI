...
import Infraestructuraimg from '../images/infra.png';
    ...
    return(
        <Fragment>
            ...
            <div className=" relative pickgradient  flex items-center w-full">
                <div>
                    <img src={Infraestructuraimg} className="img-gradient" />
                </div>
                <div className="flex flex-col absolute flex items-center justify-center z-10 inset-0">
                    <div className="text-center">
                        <h1 className=" break-normal responsive-title text-white font-bold  md:text-4xl ">Infraestructura Física y Telecomunicaciones </h1>
                    </div>
                    <div>
            ...
            <div className="flex responsive-div-text-CAS-P justify-items-center items-center">
                ...
                <div className=" flex flex-col responsive-div-card-perfil-CAS justify-center justify-items-center items-center shadow-2xl relative z-40 bg-white ">
                    ...
                    <h1 className="font-bold text-blue-700 mt-5 responsive-name-perfil-CAS-P break-all">Jesus Reyes Castallón</h1>
                    <h2 className="font-bold text-gray-600 mt-5 responsive-contact-perfil-CAS-P">(442)192-12-00 </h2>
                    <h3 className="font-bold text-gray-600 mt-5 responsive-contact-perfil-CAS-P">Extensión: 3272</h3>
                    </div>
                </div>
                </div>
                <div className="responsive-width-p-CAS-P">
                <p className="leading-loose text-justify">
                    Se encarga de diseñar, desarrollar e implementar sistemas de comunicación a nivel físico en la Red Institucional de Cómputo (RIC), mediante diferentes soluciones, como:
                    <br /><br />
                </p><h3 className="font-bold text-blue-700 mt-5 responsive-name-perfil-CAS-P break-all">Sistema de cableado estructurado <br /><br /> Sistemas de fibra optica <p /> Sistemas eléctircos y enérgias alternativas</h3>
                <br /><br />
                Otorgando un servicio de calidad y con tecnología de última 
                generación. 
                <p />
                </div>
            </div>
...
const infraestructuraFisica = () => {
    document.title = 'DGSI | Infraestructura Física y Telecomunicaciones';
    return (  
        <Fragment>
