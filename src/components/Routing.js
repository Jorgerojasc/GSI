    ...
    return(
        <Fragment>
            <div  className=" relative pickgradient  flex items-center w-full">
                <div >
                    <img src={Routingimg} className="img-gradient"  />

                </div>
                <div className="flex flex-col absolute flex items-center justify-center z-10 inset-0">

                    <div className="text-center">
                        <h1 className=" break-normal responsive-title text-white font-bold  md:text-4xl ">Coordinación de Switching & Routing </h1>
            ...
            <div>
                <p className="break-normal text-blue-600 font-bold  text-base md:text-lg pt-5">Encargado de Switching &amp; Routing</p>
            </div>
            </div>
            <section className="grid">
                <div className="div1 mx-auto h-auto w-auto  container mx-auto flex items-center pt-9">
                    <div id="tabla1">
                        <div id="cabtab1">
                        ...
                        <div className="text-center" id="cuerpotab1">
                            <p className="text-blue-600 font-bold text-base md:text-lg pt-7">Jesús Ramírez Bocanegra</p>
                            <p className="text-gray-700 font-bold text-xs md:text-md pt-3">(442) 192-12-00</p>
                            <p className="text-gray-700 font-bold text-xs md:text-md pb-5">Extensión 3274</p>
                        </div>
                    </div>
                ...
                <div className="div2 mx-auto h-auto w-auto  container mx-auto">
                    <div>
                        <h1 className="text-blue-600 font-bold text-4xl pb-8 pt-16">SWITCHING &amp; ROUTING</h1>
                    </div>
                    <div className="mr-14">
                        <p className="text-gray-500 text-xs pb-5">Es la encargada del funcionamiento de la RIC, ya que permite la conexión de computadores y periféricos mediante dos partes del equipo: <b style={{color: '#228FFD'}}>switches y routers</b>, estos dos elementos permiten a los dispositivos conectados a la red comunicarse con los demás y con otras redes. Los switches se utilizan para conectar varios dispositivos a través de la misma red dentro de un edificio u oficina. Por ejemplo, un switch puede conectar sus computadoras, impresoras y servidores, creando una red de recursos compartidos. Los routers se utilizan para conectar varias redes. Por ejemplo, puede utilizar un router para conectar sus computadoras en red a internet y de esta forma, compartir una conexión de internet entre varios usuarios.</p>
                    </div>
                </div>
                <div className="div3">
                </div>
                <div className="div4">
                    <div className="poligono3"></div>
                </div>
            </section>
        </Fragment>
    );
...
const Routing = () => {
    document.title = 'DGSI | Coordinación de Switching & Routing ';
